...
parser.add_argument(
    ...
    help='\
        Set log level to a levelname. \
        This argument only take effect in stdout')

# shell customization
shell_customization_parser = parser.add_argument_group(
    'Shell Customization Option')
...
shell_customization_parser.add_argument(
    ...
    help='''\
        This command used to change the prompt to be looks like \
        POSIX or Windows Prompt'''
)

shell_customization_parser.add_argument(
    '--set-prompt-symbol', default=None, metavar='symbol',
    help='\
        Set particular prompt symbol to terminal. \
        This option didn\'t take effect when \
